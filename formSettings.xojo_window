...
Begin DesktopWindow formSettings
   ...
   Begin DesktopGroupBox GroupBox1
      ...
      Begin DesktopLabel lblIPorPort
         ...
         Width           =   75
      End
      Begin DesktopTextField SPE1KIP
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
      ...
      Begin DesktopLabel Label1
         ...
         Width           =   75
      End
      Begin DesktopTextField SPE1KPort
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  SPE1KIP.Text =  Preferences.SPE1KIP
		  SPE1KPort.text =  Preferences.SPE1KPort
		  RadioGroup1.SelectedIndex = Preferences.SPE1KComType
		  for i as integer = 0 to DevicesPopupMenu.RowCount-1
		    if DevicesPopupMenu.RowTextAt(i) = Preferences.SPE1KSerialPort and Preferences.SPE1KSerialPort <> "" then 
		  ...
		  for i as integer = 0 to cmbBaud.RowCount - 1
		    if cmbBaud.RowTextAt(i) = Preferences.SPE1KSerialBaud and Preferences.SPE1KSerialBaud <> "" then
		      cmbBaud.SelectedRowIndex = i
		    end if
		  next
		  
		  if radiogroup1.SelectedIndex = 0 then
		    SPE1KIP.Enabled = True
		    SPE1KPort.Enabled = true
		    cmbBaud.Enabled = false
		    DevicesPopupMenu.Enabled = false
		  else
		    SPE1KIP.Enabled = False
		    SPE1KPort.Enabled = False
...
#tag Events ButtonSave
	#tag Event
		Sub Pressed()
		  Preferences.SPE1KIP = SPE1KIP.Text
		  Preferences.SPE1KPort = SPE1KPort.Text
		  Preferences.SPE1KComType = RadioGroup1.SelectedIndex
		  Preferences.SPE1KSerialPort = DevicesPopupMenu.SelectedRowText
		  Preferences.SPE1KSerialBaud = cmbBaud.SelectedRowText
